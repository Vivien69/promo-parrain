...
<section class="block_inside">
    ...
    <p>Si je ne trouve pas mon marchand en tapant au moin les 2 premières lettre de son nom, je propose un marchand : </p>
        ...
        <label style="min-width:100px;"></label>
            <p style="max-width:500px;font-weight:bold;">Le parrainage <span id="nomsitephrase"></span> octroie <span id="gain_filleul"></span><span id="devise_gain"></span> au filleul</p>
        </li>
        ...
        <p>Si vous offrez un bonus par paypal complétez le champ ci-dessous :</p>
            ...
            <li>
                ...
                <input type="text" id="bonus" name="bonus" placeholder="Ex : 2" style="width:5%;min-width:60px;max-width:60px;margin-left:8px" <?= (isset($data['form']['bonus']) ? 'value="'.$data['form']['bonus'].'"' : ''); ?>>&nbsp; €
                ...
                <?= (isset($data['info']['bonus']) != '' ? $data['info']['bonus'] : '' ); ?>
            </li>
            ...
            <li style="background-color:#FFF;padding-top:15px;margin-bottom:5px;">
                ...
                <div class="choiceType" id="choixcode" style="margin-left:8px">
                    <label for="choixcodelien" class="radios"><input type="radio" id="choixcodelien" name="choicecode" value="1" <?= (isset($data['form']['choicecode']) && $data['form']['choicecode'] == '1' ? 'checked' : ''); ?>>Code ou lien</label>
